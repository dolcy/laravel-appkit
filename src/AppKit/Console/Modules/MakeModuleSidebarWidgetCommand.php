 ...
 */
class MakeModuleSidebarWidgetCommand extends Command
{
	/**
	 * @var string $name The console command name.
	 */
	protected $name = 'appkit:make:module:sidebar:widget';

	/**
	 * @var string $description The console command description.
	 */
	protected $description = 'Create a new sidebar widget for module';
	...
	{
		return $this->handler->fire($this, $this->argument('module'), $this->argument('name'), 'sidebar');
	}
